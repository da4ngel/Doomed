...
Latest local scoped result, including P1 conflict tests: **150 passed, 7 skipped**. Lint, formatting, and reasoning type checks pass. The earlier broader `tests/unit tests/reasoning` run: **198 passed, 48 skipped, 2 existing upstream failures**.
